...
public class GPU {
    ...
    public static List<GPU> initializeGPUs() {
        return Arrays.asList(
            ...
            new GPU("NVIDIA GeForce GTX 1060 6GB", 22, 120, 400, 6, "Budget", 68),
            
            // Mid-Range GPUs ($500-1500)
            new GPU("NVIDIA GeForce GTX 1660 SUPER", 31, 125, 800, 6, "Mid-Range", 69),
            new GPU("AMD RX 5600 XT", 40, 150, 1000, 6, "Mid-Range", 71),
            new GPU("NVIDIA RTX 2060", 32, 160, 1200, 6, "Mid-Range", 70),
            new GPU("NVIDIA RTX 2070", 42, 175, 1400, 8, "Mid-Range", 71),
            ...
            new GPU("NVIDIA RTX 3080", 64, 300, 2300, 10, "High-End", 73),
            new GPU("NVIDIA RTX 3090", 98, 320, 2800, 24, "High-End", 72),
            
            // Premium GPUs ($3000+)
            new GPU("NVIDIA RTX 4070", 100, 285, 3200, 12, "Premium", 71),
            new GPU("AMD RX 7900 XTX", 110, 355, 3500, 24, "Premium", 73),
            new GPU("NVIDIA RTX 4080", 130, 320, 3800, 16, "Premium", 73),
